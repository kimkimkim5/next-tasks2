...
interface EditTaskFromProps {
    task: TaskDocument;
}

const EditTaskForm : React.FC<EditTaskFromProps> = ({task}) => {
...
const SubmitButton = () => {
    ...
    return             (<button type='submit' disabled={pending} className='mt-8 py-2 w-full rounded-md text-white
            bg-gray-800 hover:bg-gray-700 text-sm font-semibold shadow-sm disabled:bg-gray-400'>修正</button>)
}
